...
CCACHE := ccache
GCC := linaro-arm-eabi-4.10
VER := 4.9.1-2014.06.20140614.CR83
...
ARCH		?= arm
CROSS_COMPILE	?= $(CCACHE) `pwd`/../$(GCC)/bin/arm-eabi-
...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -munaligned-access -mfpu=neon-vfpv4 -ftree-vectorize
AFLAGS_KERNEL	= -munaligned-access -mfpu=neon-vfpv4 -ftree-vectorize
